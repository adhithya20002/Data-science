...
Label(root, text="facebook", fg="Dodger Blue", bg="White",font=("Facebook Sans", 28, "bold")).pack(pady=20)
...
Button(root, text="Log In", bg="Dodger Blue",fg="white", width=25,command=login).pack(pady=10)
